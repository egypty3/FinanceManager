    ...
    public class SummaryController : Controller
    {
        ...
        public ViewResult Index(string date)
        {
            ...
            ViewBag.summaryMessage = (Summary.IncomesSum > Summary.ExpensesSum) ?
                                     "Way to go! Your monthly income is greater than what you spend." :
                                     "Unfortunately, this month your expenses exceeded your income.";
        ...
        public PartialViewResult ExpenseDetails(string date)
        {
            ...
            {
                ViewBag.noRecords = "No expenses this month!";
