    ...
    public class IncomeController : Controller
    {
        ...
        public ActionResult Edit(Income income)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["message"] = string.Format("Updated {0}", income.Description);
        ...
        public ActionResult Create(Income income)
        {
            ...
            {
                repository.Save(income);
                TempData["message"] = string.Format("Created {0}", income.Description);
                return RedirectToAction("Index");
            }
            else
            {
        ...
        public ActionResult Delete(int incomeID)
        {
            ...
            {
                TempData["message"] = string.Format("Removed {0} of {1}", deletedIncome.Description, deletedIncome.Date.ToString("d"));
            }
