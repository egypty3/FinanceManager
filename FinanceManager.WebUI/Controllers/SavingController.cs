    ...
    public class SavingController : Controller
    {
        ...
        public ActionResult Edit(Saving saving)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["message"] = string.Format("Updated {0}", saving.Description);
        ...
        public ActionResult Create(Saving saving)
        {
            ...
            {
                repository.Save(saving);
                TempData["message"] = string.Format("Created {0}", saving.Description);
                return RedirectToAction("Index");
            }
            else
            {
        ...
        public ActionResult Delete(int savingID)
        {
            ...
            {
                TempData["message"] = string.Format("Removed {0} of {1}", deletedSaving.Description, deletedSaving.Date.ToString("d"));
            }
