    ...
    public class ExpenseController : Controller
    {
        ...
        public ActionResult Edit(Expense expense)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["message"] = string.Format("Updated {0}", expense.Description);
        ...
        public ActionResult Create(Expense expense)
        {
            ...
            {
                repository.Save(expense);
                TempData["message"] = string.Format("Created {0}", expense.Description);
                return RedirectToAction("Index");
            }
            else
            {
        ...
        public ActionResult Delete(int expenseID)
        {
            ...
            {
                TempData["message"] = string.Format("Removed {0} of {1}", deletedExpense.Description, deletedExpense.Date.ToString("d"));
            }
